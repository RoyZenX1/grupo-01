...
/* ---------- 3. BigInt para el identificador de operación ---------- */
let correlativo = 0n;
...
/* ---------- 4. Conversión y validación de entradas ---------- */
function convertirImporteACentimos(texto) {
  ...
  if (centimos > 1000000 * 100) {
    throw new RangeError("El precio no debe superar S/ 1 000 000.00.");
  }
...
function mostrarResultado(resultado) {
  ...
  salidas.descuento.value =
    `-${formatearCentimos(resultado.descuentoCentimos)} (${resultado.descuentoAplicado} %)`;
