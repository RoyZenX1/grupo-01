...
// ============================================
// 4. BIGINT: IDENTIFICADOR DE OPERACIÓN
// ============================================
let correlativo = 0n;
...
// ============================================
// 5. CONVERSIÓN DE PRECIO A CÉNTIMOS
// ============================================
...
// ============================================
// 7. OPERACIONES CON BANDERAS (BITS)
// ============================================
...
// ============================================
// 8. REST / SPREAD: SUMA DE COMPONENTES
// ============================================
...
function calcularCotizacion(datos, opciones = {}) {
    ...
    const descuentoCentimos = Math.round(subtotalCentimos * descuentoAplicado / 100);
    const baseImponibleCentimos = subtotalCentimos - descuentoCentimos;
    const igvCentimos = Math.round(baseImponibleCentimos * reglas.igvPorcentaje / 100);
